...
import 'search_and_discovery_home_model.dart';
export 'search_and_discovery_home_model.dart';

class SearchAndDiscoveryHomeWidget extends StatefulWidget {
  const SearchAndDiscoveryHomeWidget({super.key});

  @override
  State<SearchAndDiscoveryHomeWidget> createState() =>
      _SearchAndDiscoveryHomeWidgetState();
}

class _SearchAndDiscoveryHomeWidgetState
    extends State<SearchAndDiscoveryHomeWidget> {
  late SearchAndDiscoveryHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchAndDiscoveryHomeModel());
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child: SvgPicture.asset(
                                          'assets/images/Group_48097120.svg',
                                          height: 60.0,
                                          fit: BoxFit.contain,
                                        ),
                                      ),
