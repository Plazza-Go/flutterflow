...
import 'search_medicine_copy_model.dart';
export 'search_medicine_copy_model.dart';

class SearchMedicineCopyWidget extends StatefulWidget {
  const SearchMedicineCopyWidget({super.key});

  @override
  State<SearchMedicineCopyWidget> createState() =>
      _SearchMedicineCopyWidgetState();
}

class _SearchMedicineCopyWidgetState extends State<SearchMedicineCopyWidget> {
  late SearchMedicineCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchMedicineCopyModel());
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: Visibility(
              visible: FFAppState().cartId.ticketid != 0,
              child: FutureBuilder<ApiCallResponse>(
                future: AirtableApiGroup.getMedicineDetailsCall.call(
                  orderTicketId: FFAppState().cartId.ticketid,
                  quantityvalue: 0,
                ),
                builder: (context, snapshot) {
                  ...
                  final floatingActionButtonGetMedicineDetailsResponse =
                      snapshot.data!;
                    ...
                    child: badges.Badge(
                      badgeContent: Text(
                        valueOrDefault<String>(
                          AirtableApiGroup.getMedicineDetailsCall
                              .recordList(
                                floatingActionButtonGetMedicineDetailsResponse
                                    .jsonBody,
                              )
                              ?.length
                              ?.toString(),
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      _model.delete1 = await AirtableApiGroup
                                          .deleteCall
                                          .call(
