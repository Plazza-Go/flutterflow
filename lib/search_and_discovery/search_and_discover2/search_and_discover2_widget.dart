...
class SearchAndDiscover2Widget extends StatefulWidget {
  const SearchAndDiscover2Widget({super.key});

  @override
  State<SearchAndDiscover2Widget> createState() =>
      _SearchAndDiscover2WidgetState();
}

class _SearchAndDiscover2WidgetState extends State<SearchAndDiscover2Widget> {
  late SearchAndDiscover2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchAndDiscover2Model());
