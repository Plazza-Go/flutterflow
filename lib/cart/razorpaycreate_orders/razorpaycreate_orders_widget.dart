...
import 'razorpaycreate_orders_model.dart';
export 'razorpaycreate_orders_model.dart';

class RazorpaycreateOrdersWidget extends StatefulWidget {
  const RazorpaycreateOrdersWidget({
    super.key,
  ...
  @override
  State<RazorpaycreateOrdersWidget> createState() =>
      _RazorpaycreateOrdersWidgetState();
}

class _RazorpaycreateOrdersWidgetState
    extends State<RazorpaycreateOrdersWidget> {
  late RazorpaycreateOrdersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RazorpaycreateOrdersModel());
                                                                  ...
                                                                  children: List.generate(
                                                                    ...
                                                                    return wrapWithModel(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        key:
                                                                            Key(
                                                                          'Keymj5_${medicineIndex.toString()}',
                                                                        ),
                                                                        medicineimageurl:
                                                                            getJsonField(
                                                                          medicineItem,
                                                                        ...
                                                                        orderSource:
                                                                          ...
                                                                          AirtableApiGroup
                                                                              .findSingleOrderCall
                                                                              .orderSource(
                                                                            razorpaycreateOrdersFindSingleOrderResponse.jsonBody,
                                                                          ),
                                                                          'Rx',
                                                                        ),
                                                                      ),
