...
import 'medicine_cart_search_model.dart';
export 'medicine_cart_search_model.dart';

class MedicineCartSearchWidget extends StatefulWidget {
  const MedicineCartSearchWidget({
    super.key,
  ...
  @override
  State<MedicineCartSearchWidget> createState() =>
      _MedicineCartSearchWidgetState();
}

class _MedicineCartSearchWidgetState extends State<MedicineCartSearchWidget> {
  late MedicineCartSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicineCartSearchModel());
                                                                  ...
                                                                  children: List.generate(
                                                                    ...
                                                                    return wrapWithModel(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        key:
                                                                            Key(
                                                                          'Key44b_${medicineIndex.toString()}',
                                                                        ),
                                                                        medicineimageurl:
                                                                            getJsonField(
                                                                          medicineItem,
                                                                        ...
                                                                        orderSource:
                                                                          ...
                                                                          AirtableApiGroup
                                                                              .findSingleOrderCall
                                                                              .orderSource(
                                                                            medicineCartSearchFindSingleOrderResponse.jsonBody,
                                                                          ),
                                                                          'Rx',
                                                                        ),
                                                                      ),
