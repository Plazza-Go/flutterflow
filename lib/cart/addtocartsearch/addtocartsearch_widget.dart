...
import 'addtocartsearch_model.dart';
export 'addtocartsearch_model.dart';

class AddtocartsearchWidget extends StatefulWidget {
  const AddtocartsearchWidget({
    super.key,
    this.productID,
    this.name,
    this.mrp,
  ...
  @override
  State<AddtocartsearchWidget> createState() => _AddtocartsearchWidgetState();
}

class _AddtocartsearchWidgetState extends State<AddtocartsearchWidget> {
  late AddtocartsearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddtocartsearchModel());
